...
for i in singleDigitPrimes:
	for j in singleDigitPrimes:
		if(p.factor(i*10+j)==None):
			print i*10+j
			trunc2.append(i*10+j)
...
def check(n):
	...
	for i in range(0,length):
		if(p.factor(int(string[0:length-i]))!=None or int(string[0:length-i])==1):
			return False			
	for i in range(0,length):
		if(p.factor(int(string[i:]))!=None or int(string[i:])==1):
			return False	
	return True		
	
print check(1373)

for i in range(10,850000):
	if((str(i)[0]=="2" or str(i)[0]=="5" or str(i)[0]=="3" or str(i)[0]=="7") and (str(i)[len(str(i))-1]=="2" or str(i)[len(str(i))-1]=="5" or str(i)[len(str(i))-1]=="3" or str(i)[len(str(i))-1]=="7")):
		if check(i):
			print i
